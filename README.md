...
| oidc.clientSecret           | Yes  |             | The secret associated to this client ID                                                                                                                                                                           |
...
| userConfigFile              | No   |             | The path (Relative to config file) providing users permissions (Exclusive from `userConfigMap.*` parameter). See 'Users permissions' below                                                                        |
| userConfigMap.configMapName | No   |             | The name of the Kubernetes configMap hosting the users permissions. (Exclusive from `userConfigFile` parameter). See 'Users permissions' below                                                                    |
